import 'package:ecommerce/controller/auth/verifiycodesginup_controller.dart';
...
class VerfiyCodeSignUp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    VerifiycodesginupControllerImp controller = Get.put(
      VerifiycodesginupControllerImp(),
    );
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
